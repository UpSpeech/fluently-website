  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -bottom-20 -left-20 w-40 h-40 bg-gradient-to-br from-calm-charcoal/10 to-calm-navy/10 rounded-full blur-2xl animate-float"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute top-1/2 right-1/4 w-20 h-20 bg-gradient-to-br from-calm-lavender/15 to-calm-light rounded-full blur-xl animate-float"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-calm-navy/20 to-calm-lavender/20 rounded-full mb-6 border border-calm-navy/30 backdrop-blur-sm">
            <span className="text-calm-charcoal text-sm font-medium">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {problems.map((problem, index) => (
            ...
            >
              ...
              {/* Icon Container */}
              <div
                className={`relative z-10 w-16 h-16 rounded-2xl ${problem.accentColor} flex items-center justify-center text-2xl mb-4 group-hover:scale-125 group-hover:rotate-6 transition-all duration-500 shadow-sm m-6`}
              >
              ...
              <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 overflow-hidden">
                <div className="absolute top-1/2 left-1/2 w-8 h-8 bg-calm-lavender/15 rounded-full -translate-x-1/2 -translate-y-1/2 group-hover:scale-[25] transition-transform duration-600 ease-out"></div>
                <div className="absolute top-1/2 left-1/2 w-4 h-4 bg-calm-navy/10 rounded-full -translate-x-1/2 -translate-y-1/2 group-hover:scale-[35] transition-transform duration-800 ease-out delay-100"></div>
              </div>
            </div>
          ))}
        </div>
